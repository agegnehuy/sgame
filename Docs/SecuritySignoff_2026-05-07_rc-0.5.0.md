# Security Sign-off — 2026-05-07 (rc-0.5.0)

Use this as the build-specific security decision record for the release candidate.
...
- **Notes / risk acceptance:** `No unresolved security blockers. Proceed to full pilot readiness checks.`
