...
namespace SGame.UI
{
    public class AnalyticsSummaryExportController : MonoBehaviour
    {
        ...
        [SerializeField] private string successPrefixDefault = "Analytics summary saved:";
        [SerializeField] private string failMessageDefault = "Failed to export analytics summary.";
        [Header("Localization keys")]
        [SerializeField] private string successPrefixKey = "ui.export.analytics_saved";
        [SerializeField] private string failMessageKey = "ui.export.analytics_failed";
        ...
        private void OnExportPressed()
        {
            try
            {
                _lastExportPath = AnalyticsSummaryExportService.ExportSummary();
